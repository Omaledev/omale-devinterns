    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function calculateTotals() {
            document.querySelectorAll('.student-row').forEach(row => {
                ...
                totalCell.textContent = total.toFixed(1); // Show 1 decimal place if needed
                
                // Color code score (Red if below 50, Green if above 75)
                totalCell.classList.remove('text-danger', 'text-success', 'text-warning');
                if(total < 50) {
