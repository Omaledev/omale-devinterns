                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Edit Bursar</li>
                        </ol>
                    </nav>
                </div>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <a href="{{ route('schooladmin.bursars.index') }}" class="btn btn-outline-secondary me-2">
                ...
                <div class="col-12">
                    <div class="card shadow">
                        <div class="card-header bg-white py-3">
                            <h6 class="m-0 fw-bold text-primary">Edit Bursar Information</h6>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('schooladmin.bursars.update', $bursar) }}" method="POST">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-check form-switch">
                                                <input class="form-check-input" type="checkbox" id="is_approved" name="is_approved" value="1" 
                                                    {{ $bursar->is_approved ? 'checked' : '' }}>
                                                <label class="form-check-label" for="is_approved">
                                                    Approve Account (Active)
                                                </label>
                                            </div>
                                            <small class="text-muted">Unchecking this will prevent the bursar from logging in.</small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('address') is-invalid @enderror"
                                              id="address" name="address" rows="3">{{ old('address', $bursar->address) }}</textarea>
                                </div>
