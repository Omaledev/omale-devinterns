                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('finance.fee-structures.update', $feeStructure->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $feeStructure->name }}" required>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="amount" class="form-control" value="{{ $feeStructure->amount }}" min="0" required>
                        </div>

                        <button class="btn btn-primary w-100">Update Fee</button>
                    </form>
                </div>
            </div>
        </div>
