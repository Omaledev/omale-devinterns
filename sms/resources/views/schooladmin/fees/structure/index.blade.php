                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">
                                        <div class="btn-group" role="group">
                                            ...
                                            {{-- Delete Button --}}
                                            <form action="{{ route('finance.fee-structures.destroy', $fee->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this fee structure?');" class="d-inline">
                                                @csrf @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="5" class="text-center text-muted py-4">
                                        <i class="fas fa-file-invoice-dollar fa-2x mb-2 d-block text-gray-300"></i>
